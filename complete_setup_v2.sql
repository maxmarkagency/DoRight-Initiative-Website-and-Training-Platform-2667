-- COMPLETE FRESH DATABASE SETUP V2 - Handles existing objects gracefully
-- This version safely handles duplicates

-- Enable necessary extensions
CREATE EXTENSION IF NOT EXISTS "uuid-ossp";

-- Create all custom types (handle existing types)
DO $$ BEGIN
...
-- Handle existing policies by dropping them first, then creating new ones
...
-- Success message
SELECT '🎉 SUCCESS! Complete DoRight LMS database setup complete!' as result;
SELECT '✅ All critical tables created: users, courses, modules, lessons, enrollments, progress' as tables;
SELECT '✅ Security policies configured' as security;
SELECT '✅ Database ready for application use!' as status;