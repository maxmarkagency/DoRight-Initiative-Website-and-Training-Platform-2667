...
const { FiGrid, FiBookOpen, FiTrendingUp, FiAward, FiUser, FiSettings, FiLogOut, FiChevronsLeft, FiChevronsRight, FiTarget, FiCalendar, FiMessageSquare } = FiIcons;
...
const StudentSidebar = () => {
  ...
  const navLinks = [
    ...
    { name: 'My Courses', path: '/dashboard/courses', icon: FiBookOpen },
    { name: 'Progress', path: '/dashboard/progress', icon: FiTrendingUp },
    { name: 'Learning Calendar', path: '/dashboard/calendar', icon: FiCalendar },
    { name: 'Certificates', path: '/dashboard/certificates', icon: FiAward },
    { name: 'Community Forum', path: '/dashboard/forum', icon: FiMessageSquare },
  ];
