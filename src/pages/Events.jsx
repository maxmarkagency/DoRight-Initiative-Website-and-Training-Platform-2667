            ...
            <div className="grid gap-10 md:grid-cols-2">
              {upcomingEvents.map((event, index) => (
                <motion.div
                  ...
                  whileHover={{ scale: 1.03, boxShadow: '0 4px 12px rgba(13,14,22,0.15)' }}
                ...
                >
                  ...
                  <div className="p-8">
                    ...
                    {event.event_type && (
                      <div className="mt-2">
                        <span className="inline-block bg-accent text-neutral-900 text-xs font-semibold px-3 py-1 rounded-full">
                          {event.event_type}
                        </span>
                      </div>
                    )}
                    ...
                    <a
                      ...
                      className="mt-8 bg-accent text-neutral-900 font-bold py-3 px-6 rounded-lg hover:brightness-90 transition-colors duration-300 w-full sm:w-auto inline-block text-center"
                    >
                      Learn More & Register
                    </a>
                  </div>
